...
<body>
		...
		<div class='container-fluid'>
			...
			<div class='collapse navbar-collapse'
				...
				<ul class='nav navbar-nav navbar-right'>
					<li class="active"><a class='menu' href="#">도움말</a></li>
	...
	<div class='Login_Body'>
		<div class='login_page container'>
			<div class='row'>
				<div
					class='Yq_login col-lg-6 col-lg-offset-3 col-sm-6 col-sm-offset-3 col-xs-6 col-xs-offset-3'>
					...
					<div class='student_body panel-body'>
						<div class='row'>
							<form id='login-success' action='Login.do' method='post'
								role='form'>
								<div class='student_input form-group col-lg-8 col-lg-offset-2'>
									<input type='text' name='stu_id' id='stu_id' tabindex='1'
										class='form-control' placeholder='학번' />
								</div>
								<div class='form-group col-lg-8 col-lg-offset-2'>
									<input type='password' name='stu_pw' id='stu_pw' tabindex='2'
								...
								<div class='student_btn form-group col-lg-4 col-lg-offset-4'>
									...
									<input type='submit' id='login_Button' value='로그인'
										class='form-control' onclick='return loginCheck()' /> <input
										type='reset' id='login_Cancel' value='취소' class='form-control' />
								</div>
							</form>

							<form id='admin_login' action='AdminLogin.do' method='post'
								role='form'>
								<div class='admin_input form-group col-lg-8 col-lg-offset-2'>
									<input type='text' name='ad_id' id='ad_id' tabinbox='1'
										class='form-control' placeholder='관리자번호' />
								</div>
								<div class='form-group col-lg-8 col-lg-offset-2'>
									<input type='password' name='ad_pw' tabinbox='2'
