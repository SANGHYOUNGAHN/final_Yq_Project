...
<div class="tabWrap">
    ...
    <div class="tab_Content_Wrap">
        ...
        <input type="submit" value="검색">
      	...
      	<div id="TAB1">
            ...
            <br><br>		
				 ...
				 <c:forEach var="inSung" items="${inTotList}">
				<tr>
				<td>월별 충전 금액: ${inSung.insungTot}</td>	
            	 ...
            	 <c:forEach var="inSung" items="${inAwList}">
            	 <tr>
            	 <td>${inSung.mn_name}
				 <td>${inSung.insungAward}</td>	
				 </tr>
				 </c:forEach>
				 </table>
        ...
        <div id="tabContent02" class="tabPage">
              <br><br>
        <center>
        <form method="post" action="AdminHwan.do">
        <input type="text" name="con">
        <input type="submit" value="검색">
       	<h3>검색할 월 입력</h3>
       	<h5>(ex)2017년 5월 => 2017-05</h5>
      	...
      	<div id="TAB2">
            ...
            <br><br>		
            	 <table style="width=2000; table-layout:fixed;" borderColor=#000000 cellSpacing=0 cellPadding=0 border=1 align="center">
				<c:forEach var="hwan" items="${hwanList}">
				<tr>
				<td>월별 충전 금액: ${hwan.hwanTot}</td>	
            	 ...
            	 <c:forEach var="hwan" items="${hwanAwardList}">
            	 <tr>
            	 <td>${hwan.mn_name}
				 <td>${hwan.hwanAward}</td>	
				 </tr>
				 </c:forEach>
				 </table>
				</div>
        ...
        <div id="tabContent03" class="tabPage">
               <br><br>
        <center> <form method="post" action="AdminDormTot.do">
        <input type="text" name="con">
        <input type="submit" value="검색">
       	<h3>검색할 월 입력</h3>
       	<h5>(ex)2017년 5월 => 2017-05</h5>
      	...
      	<div id="TAB3">
            ...
            <br><br>		
				...
				<td>월별 충전 금액: ${dorm.dormTot}</td>	
            	 ...
            	 <c:forEach var="dorm" items="${dormAwardList}">
            	 <tr>
            	 <td>${dorm.mn_name}
				 <td>${dorm.dormAward}</td>	
				 </tr>
				 </c:forEach>
				 </table>
